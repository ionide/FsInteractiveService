...
let website = "/FsInteractiveService"

let githubLink = "http://github.com/ionide/FsInteractiveService"

// Specify more information about your project
let info =
  [ "project-name", "FsInteractiveService"
    "project-author", "Tomas Petricek"
    "project-summary", "F# interactive service API exposed via a lightweight HTTP server"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FsInteractiveService" ]
